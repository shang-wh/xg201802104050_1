...
public class ProfTitleController extends HttpServlet {
    //    GET, http://localhost:8888/profTitle.ctl?id=1, 查询id=1的职称
    //    GET, http://localhost:8888/profTitle.ctl, 查询所有的职称
    //    POST, http://localhost:8888/profTitle.ctl, 增加职称
    //    PUT, http://localhost:8888/profTitle.ctl, 修改职称
    //    DELETE, http://localhost:8888/profTitle.ctl?id=1, 删除id=1的职称
    ...
    /**
     * POST,http://localhost:8888/profTitle.ctl
    ...
    /**
     * DELETE, http://localhost:8888/profTitle.ctl?id=1
    ...
    /**
     * PUT, http://localhost:8888/profTitle.ctl
