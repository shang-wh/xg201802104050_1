...
public class DegreeController extends HttpServlet {
    //    GET, http://localhost:8888/degree.ctl?id=1, 查询id=1的学位
    //    GET, http://localhost:8888/degree.ctl, 查询所有的学位
    //    POST, http://localhost:8888/degree.ctl, 增加学位
    //    PUT, http://localhost:8888/degree.ctl, 修改学位
    //    DELETE, http://localhost:8888/degree.ctl?id=1, 删除id=1的学位
    ...
    /**
     * POST,http://localhost:8888/degree.ctl
    ...
    /**
     * DELETE, http://localhost:8888/degree.ctl?id=1
    ...
    /**
     * PUT, http://localhost:8888/degree.ctl
