...
public class DepartmentController extends HttpServlet {
    //    GET, http://localhost:8888/department.ctl?id=1, 查询id=1的系
    //    GET, http://localhost:8888/department.ctl, 查询所有的系
    //    POST, http://localhost:8888/department.ctl, 增加系
    //    PUT, http://localhost:8888/department.ctl, 修改系
    //    DELETE, http://localhost:8888/department.ctl?id=1, 删除id=1的系
    ...
    /**
     * POST,http://localhost:8888/department.ctl
    ...
    /**
     * DELETE, http://localhost:8888/department.ctl?id=1
    ...
    /**
     * PUT, http://localhost:8888/department.ctl
