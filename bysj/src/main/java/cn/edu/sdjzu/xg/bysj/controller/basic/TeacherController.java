...
public class TeacherController extends HttpServlet {
    //    GET, http://localhost:8888/teacher.ctl?id=1, 查询id=1的教师
    //    GET, http://localhost:8888/teacher.ctl, 查询所有的教师
    //    POST, http://localhost:8888/teacher.ctl, 增加教师
    //    PUT, http://localhost:8888/teacher.ctl, 修改教师
    //    DELETE, http://localhost:8888/teacher.ctl?id=1, 删除id=1的教师
    //   http://49.234.227.112:8080/bysj1850/myschool/index.html   前台url
    /**
     * 方法-功能
     * put 修改
     * post 添加
...
//            "remarks": ""}}
    /**
     * POST,http://localhost:8888/teacher.ctl
    ...
    /**
     * DELETE, http://localhost:8888/teacher.ctl?id=1
    ...
    /**
     * PUT, http://localhost:8888/teacher.ctl
