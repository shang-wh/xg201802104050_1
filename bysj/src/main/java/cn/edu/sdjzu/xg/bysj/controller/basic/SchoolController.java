...
public class SchoolController extends HttpServlet {
    //    GET, http://localhost:8888/school.ctl?id=1, 查询id=1的学院
    //    GET, http://localhost:8888/school.ctl, 查询所有的学院
    //    POST, http://localhost:8888/school.ctl, 增加学院
    //    PUT, http://localhost:8888/school.ctl, 修改学院
    //    DELETE, http://localhost:8888/school.ctl?id=1, 删除id=1的学院
    ...
    /**
     * POST,http://localhost:8888/school.ctl
    ...
    /**
     * DELETE, http://localhost:8888/school.ctl?id=1
    ...
    /**
     * PUT, http://localhost:8888/school.ctl
