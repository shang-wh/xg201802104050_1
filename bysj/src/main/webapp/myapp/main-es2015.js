...
let CollegeComponent = class CollegeComponent {
    ...
    getColleges() {
        this.schoolService.getColleges()
            .subscribe(res => { this.colleges = res; this.leng = res.length; });
    }
    delete(college) {
...
let DegreeComponent = class DegreeComponent {
    ...
    getDegrees() {
        this.degreeService.getDegrees()
            .subscribe(res => { this.degrees = res; this.leng = res.length; });
    }
    delete(degree) {
...
let ProfTitleComponent = class ProfTitleComponent {
    ...
    getTitles() {
        this.titleService.getTitles()
            .subscribe(res => { this.titles = res; this.leng = res.length; });
    }
    delete(title) {
...
let TeacherComponent = class TeacherComponent {
    ...
    getTeachers() {
        this.teacherService.getTeachers()
            .subscribe(res => { this.teachers = res; this.leng = res.length; });
    }
    delete(teacher) {
